...
[_MACOS] = {
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ },
  {_______, LCTL(LSFT(LALT(KC_UP))), _______, _______, _______, _______, _______, LCTL(KC_1), LCTL(KC_2), LCTL(KC_3), LCTL(KC_4), _______ },
  {_______, LCTL(LSFT(LALT(KC_DOWN))), _______, _______, _______, _______, _______, LCTL(KC_5), LCTL(KC_6), LCTL(KC_7), LCTL(KC_8), _______ },
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ }
}
