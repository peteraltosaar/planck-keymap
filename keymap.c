 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |Symbol|      |Search|  VCS |Hierar| Prev |Next_M| Next |FntRes|      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_INTJ] = {
  ...
  {_______, _______, LCTL(LALT(LSFT(KC_N))), _______, LCTL(LSFT(KC_F)), LALT(KC_GRV), LCTL(LALT(KC_H)), LCTL(LALT(KC_LEFT)), LALT(KC_DOWN), LCTL(LALT(KC_RIGHT)), LCTL(LALT(LSFT(KC_SCLN))), _______ },
