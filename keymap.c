 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | IntJ | Ctrl | Alt  | GUI  |Lower |    Space    |Raise | Left | Inbox|  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
...
[_INBOX] = {
  {_______, KC_HASH, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ },
  {_______, KC_E, KC_S, _______, _______, _______, _______, _______, _______, _______, _______, _______ },
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ },
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ }
}
