 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |Refctr|Symbol|      | Open |  VCS |Hierar| Prev |Next_M| Next |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |Run It|Create|      |      | File | Menu |      |      | Info |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |    KP_0     |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
...
[_INTJ] = {
  ...
  {_______, LCTL(LALT(LSFT(KC_T))), LCTL(LALT(LSFT(KC_N))), _______, LALT(KC_F1), LALT(KC_GRV), LCTL(LALT(KC_H)), LCTL(LALT(KC_LEFT)), LALT(KC_DOWN), LCTL(LALT(KC_RIGHT)), _______, _______ },
