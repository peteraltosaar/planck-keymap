 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |HidWin|      |Symbol|      |Search|  VCS |Hierar| Prev |Next_M| Next |FntRes|      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |GoToBM|Run It|Create|S.BkMk|G.BkMk| File | Menu |Font- |Font+ | Info |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |    KP_0     |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
...
[_INTJ] = {
  ...
  {LCTL(LSFT(KC_F12)), _______, LCTL(LALT(LSFT(KC_N))), _______, LCTL(LSFT(KC_F)), LALT(KC_GRV), LCTL(LALT(KC_H)), LCTL(LALT(KC_LEFT)), LALT(KC_DOWN), LCTL(LALT(KC_RIGHT)), LCTL(LALT(LSFT(KC_SCLN))), _______ },
  {_______, LSFT(KC_F11), LCTL(LSFT(KC_F10)), LALT(KC_INS), LCTL(KC_F11), KC_F11, LCTL(LSFT(KC_N)), LSFT(LALT(KC_SCLN)), LCTL(LALT(LSFT(KC_MINS))), LCTL(LALT(LSFT(KC_EQL))), LCTL(KC_F1), _______ },
